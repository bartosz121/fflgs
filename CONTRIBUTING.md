...
Welcome to the contributor guide of fflgs.
...
If you experience bugs or general issues with fflgs, please have a look
...
You can help improve the documentation of fflgs by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/fflgs.git
   cd fflgs
   ```
